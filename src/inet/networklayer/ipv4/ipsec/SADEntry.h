...
#ifndef INET_NETWORKLAYER_IPV4_IPSEC_SADENTRY_H_
#define INET_NETWORKLAYER_IPV4_IPSEC_SADENTRY_H_
...
#endif /* INET_NETWORKLAYER_IPV4_IPSEC_SADENTRY_H_ */
