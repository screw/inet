...
class INET_API InterfaceEntry : public cModule
{
  ...
  public:
    ...
    enum {
        ...
        F_IPV4_DATA, F_IPV6_DATA, F_NEXTHOP_DATA, F_ISIS_DATA, F_TRILL_DATA, F_IEEE8021D_DATA, F_DMPR_DATA
    };
  ...
  public:
    ...
    DmprInterfaceData *dmprData() const { return dmprdata; }
    //@}
    ...
    virtual void setDmprInterfaceData(DmprInterfaceData *p);
    //@}
