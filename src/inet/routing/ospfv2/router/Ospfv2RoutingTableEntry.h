...
class INET_API Ospfv2RoutingTableEntry : public Ipv4Route
{
  ...
  private:
    ...
    std::vector<ospfv2::NextHop*> nextHops;
  ...
  public:
    ...
    virtual ospfv2::NextHop* getNextHop(unsigned int index) const  { return nextHops[index]; }
    virtual ospfv2::NextHop* getNextHop1(unsigned int index) const override { return new  ospfv2::NextHop();} //nextHops[index]; }
    void setNextHop(unsigned int index, ospfv2::NextHop*  nextHop) { nextHops[index] = nextHop; }
