...
#ifndef __INET_TCPREORDER_H
#define __INET_TCPREORDER_H
...
class INET_API TcpReorder : public cSimpleModule
{
  protected:
    typedef std::map<int64_t, std::pair<int64_t, Packet*>> SeqnoPacketnMap;
    struct ConnInfo
    {
      int64_t nextSeqNo;
//      std::vector<std::pair<int64_t, std::pair<int64_t, Packet*>>> packetVector;
      SeqnoPacketnMap seqnoPacketmap;

    };

    typedef std::map<tcp::Tcp::SockPair, ConnInfo> TcpConnMap;
...
#endif // ifndef __INET_TCPREORDER_H
